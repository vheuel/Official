...
function hexToRgb(e) {
  ...
  e = e.replace(a, (e, a, t, i) => a + a + t + t + i + i)
...
var pJS = function (e, a) {
  ...
  a && Object.deepExtend(i, a),
    ...
    (i.fn.particle.prototype.draw = function () {
      function e() {
        i.canvas.ctx.drawImage(local_img_obj, a.x - t, a.y - t, 2 * t, (2 * t) / a.img.ratio)
      }
      
      if (void 0 != this.radius_bubble) var t = this.radius_bubble
      else var t = this.radius
      if (void 0 != this.opacity_bubble) var s = this.opacity_bubble
      else var s = this.opacity
      if (this.color.rgb)
        var n = "rgba(" + this.color.rgb.r + "," + this.color.rgb.g + "," + this.color.rgb.b + "," + s + ")"
      else var n = "hsla(" + this.color.hsl.h + "," + this.color.hsl.s + "%," + this.color.hsl.l + "%," + s + ")"
      switch (((i.canvas.ctx.fillStyle = n), i.canvas.ctx.beginPath(), this.shape)) {
        case "circle":
          i.canvas.ctx.arc(this.x, this.y, t, 0, 2 * Math.PI, !1)
          break
        case "edge":
          i.canvas.ctx.rect(this.x - t, this.y - t, 2 * t, 2 * t)
          break
        case "triangle":
          i.fn.vendors.drawShape(i.canvas.ctx, this.x - t, this.y + t / 1.66, 2 * t, 3, 2)
          break
        case "polygon":
          i.fn.vendors.drawShape(
            i.canvas.ctx,
            this.x - t / (i.particles.shape.polygon.nb_sides / 3.5),
            this.y - t / 0.76,
        ...
        case "star":
          i.fn.vendors.drawShape(
            i.canvas.ctx,
            this.x - (2 * t) / (i.particles.shape.polygon.nb_sides / 4),
            this.y - t / 1.52,
          ...
          break
        case "image":
          if ("svg" == i.tmp.img_type) var local_img_obj = this.img.obj
          else var local_img_obj = i.tmp.img_obj
          local_img_obj && e()
      }
    ...
    (i.fn.interact.linkParticles = (e, a) => {
      var t = e.x - a.x,
        s = e.y - a.y,
        n = Math.sqrt(t * t + s * s)
    ...
    (i.fn.interact.attractParticles = (e, a) => {
      var t = e.x - a.x,
        s = e.y - a.y,
        n = Math.sqrt(t * t + s * s)
      if (n <= i.particles.line_linked.distance) {
    ...
    (i.fn.interact.bounceParticles = (e, a) => {
      var t = e.x - a.x,
        i = e.y - a.y,
        s = Math.sqrt(t * t + i * i),
        n = e.radius + a.radius
    ...
    (i.fn.modes.repulseParticle = (e) => {
      function a() {
        var a = Math.atan2(dist_y, dist_x)
      ...
      if (
        ...
        if (
          ...
          var c = Math.pow(i.interactivity.modes.repulse.distance / 6, 3),
            dist_x = i.interactivity.mouse.click_pos_x - e.x,
            dist_y = i.interactivity.mouse.click_pos_y - e.y,
            m = dist_x * dist_x + dist_y * dist_y,
            u = (-c / m) * 1
          c >= m && a()
        } else 0 == i.tmp.repulse_clicking && ((e.vx = e.vx_i), (e.vy = e.vy_i))
    }),
    (i.fn.modes.grabParticle = (e) => {
    ...
    (i.fn.vendors.eventsListeners = () => {
      "window" == i.interactivity.detect_on ? (i.interactivity.el = window) : (i.interactivity.el = i.canvas.el),
        ...
        i.interactivity.events.onclick.enable &&
          i.interactivity.el.addEventListener("click", () => {
            if (
    ...
    (i.fn.vendors.createSvgImg = (e) => {
      var a = i.tmp.source_svg,
        ...
        image_obj = new Image()
      image_obj.addEventListener("load", () => {
        ;(e.img.obj = image_obj), (e.img.loaded = !0), r.revokeObjectURL(c), i.tmp.count_svg++
      }),
        (image_obj.src = c)
    }),
    (i.fn.vendors.destroypJS = () => {
      cancelAnimationFrame(i.fn.drawAnimFrame), t.remove(), (pJSDom = null)
    }),
    (i.fn.vendors.drawShape = (e, a, t, i, s, n) => {
      var r = s * n,
        c = s / n,
        o = (180 * (c - 2)) / c,
    ...
    (i.fn.vendors.exportImg = () => {
      window.open(i.canvas.el.toDataURL("image/png"), "_blank")
    }),
    (i.fn.vendors.loadImg = (e) => {
...
// Fix for the arguments.callee issue - using a named function instead
Object.deepExtend = function deepExtend(e, a) {
  for (var t in a)
...
window.cancelRequestAnimFrame = (() =>
  ...
  window.msCancelRequestAnimFrame ||
  clearTimeout)()

window.pJSDom = []

window.particlesJS = (e, a) => {
  "string" != typeof e && ((a = e), (e = "particles-js"))
  e || (e = "particles-js")
  var t = document.getElementById(e),
    i = "particles-js-canvas-el",
    s = t.getElementsByClassName(i)
  if (s.length) while (s.length > 0) t.removeChild(s[0])
